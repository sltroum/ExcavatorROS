...
if("FALSE" STREQUAL "TRUE")
  set(ex_model_SOURCE_PREFIX /home/d-lab/ExcavatorROS.git/src/ex_model)
  set(ex_model_DEVEL_PREFIX /home/d-lab/ExcavatorROS.git/devel)
  set(ex_model_INSTALL_PREFIX "")
  set(ex_model_PREFIX ${ex_model_DEVEL_PREFIX})
else()
  set(ex_model_SOURCE_PREFIX "")
  set(ex_model_DEVEL_PREFIX "")
  set(ex_model_INSTALL_PREFIX /home/d-lab/ExcavatorROS.git/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ex_model' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/d-lab/ExcavatorROS.git/install/${idir}'.  Ask the maintainer 'yutak <yutak@todo.todo>' to fix it.")
    endif()

...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ex_model' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yutak/ros_ws/install_isolated/${idir}'.  Ask the maintainer 'yutak <yutak@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yutak/ros_ws/install_isolated/lib;/home/yutak/ros_ws/devel/lib;/opt/ros/indigo/lib)

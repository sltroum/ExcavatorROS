...
if("TRUE" STREQUAL "TRUE")
  set(apriltags_SOURCE_PREFIX /home/d-lab/ExcavatorROS.git/src/apriltags_ros-indigo-devel/apriltags)
  set(apriltags_DEVEL_PREFIX /home/d-lab/ExcavatorROS.git/devel)
  ...
  set(apriltags_INSTALL_PREFIX /home/d-lab/ExcavatorROS.git/install)
...
if(NOT "/home/d-lab/ExcavatorROS.git/src/apriltags_ros-indigo-devel/apriltags/include;/usr/include/eigen3;/usr/include/opencv;/usr/include " STREQUAL " ")
  set(apriltags_INCLUDE_DIRS "")
  set(_include_dirs "/home/d-lab/ExcavatorROS.git/src/apriltags_ros-indigo-devel/apriltags/include;/usr/include/eigen3;/usr/include/opencv;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/d-lab/ExcavatorROS.git/src/apriltags_ros-indigo-devel/apriltags/${idir}'.  Ask the maintainer 'Mitchell Wills <mwills@wpi.edu>' to fix it.")
    endif()

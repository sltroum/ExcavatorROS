...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'optoforce' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/filippos/ros_ws/src/optoforce/${idir}'.  Ask the maintainer 'Shadow Robot's software team <software@shadowrobot.com>' to fix it.")
    endif()
